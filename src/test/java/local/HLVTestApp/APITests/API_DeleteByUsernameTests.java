...
public class API_DeleteByUsernameTests {

	@Test(dataProvider = "csvReader", dataProviderClass = CsvDataProviders.class)
	void API_DeleteByUsername(Map<String, String> testData) {
		...
		Response response = RestAssured.delete("http://localhost:8080/users/" + username);
